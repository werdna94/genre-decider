...
GENRE_LIST = ["r-b-hip-hop", "country", "rock", "latin", "dance-electronic", "christian", "gospel", "pop", "alternative"]
...
class Genre:
    ...
    def __init__(self, genre):
        ...
        billboard_chart = Billboard(20, '{0}-songs'.format(genre))
...
def get_lyrics(song):
    ...
    try:
        ...
        lyric_box = soup.find('div', {'class': 'lyricbox'})
        if lyric_box is None:
            raise NoLyricsException("Could not find lyrics on {}".format(result_url))
